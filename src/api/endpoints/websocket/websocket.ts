...
export const getGetWsQueryOptions = <TData = Awaited<ReturnType<typeof getWs>>, TError = AxiosError<GetWs400>>(params: GetWsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWs>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
export type GetWsQueryError = AxiosError<GetWs400>
...
export function useGetWs<TData = Awaited<ReturnType<typeof getWs>>, TError = AxiosError<GetWs400>>(
