...
export const getPostAuthLoginMutationOptions = <TError = ChatServiceInternalModelsErrorResponse,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAuthLoginMutationError = ChatServiceInternalModelsErrorResponse

    /**
 * @summary User login
 */
export const usePostAuthLogin = <TError = ChatServiceInternalModelsErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAuthLogin>>, TError,{data: ChatServiceInternalModelsLoginRequest}, TContext>, }
 ): UseMutationResult<
...
export const getPostAuthRegisterMutationOptions = <TError = ChatServiceInternalModelsErrorResponse,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAuthRegisterMutationError = ChatServiceInternalModelsErrorResponse

    /**
 * @summary Register a new user
 */
export const usePostAuthRegister = <TError = ChatServiceInternalModelsErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAuthRegister>>, TError,{data: ChatServiceInternalModelsRegisterRequest}, TContext>, }
 ): UseMutationResult<
